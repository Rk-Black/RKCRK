...
cpz = "RIYAD-CP-"+str(tgl)+"-"+str(bln)+"-"+str(thn)+".txt"
okz = "RIYAD-OK-"+str(tgl)+"-"+str(bln)+"-"+str(thn)+".txt"
...
url = "https://mbasic.facebook.com/Itz.riad.khule.khele.dibo"
m_fb = "m.facebook.com"
url_youtube = "https://youtube.com/channel/UCo8W7dLKHTgyN4y26Ly3uOQ"
